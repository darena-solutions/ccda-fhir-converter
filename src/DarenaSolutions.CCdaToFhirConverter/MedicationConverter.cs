// -------------------------------------------------------------------------------------------------------------------------
// <copyright file="MedicationConverter.cs" company="Darena Solutions LLC">
        ...
        protected override Resource PerformElementConversion(XElement element, ConversionContext context)
        {
            ...
            try
            {
                ...
                if (medication.Code == null)
                    throw new RequiredValueNotFoundException(element, "manufacturedMaterial/code", "Medication.code");
            }
