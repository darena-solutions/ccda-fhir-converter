// -------------------------------------------------------------------------------------------------------------------------
// <copyright file="PractitionerRoleConverter.cs" company="Darena Solutions LLC">
...
namespace DarenaSolutions.CCdaToFhirConverter
{
    ...
    public class PractitionerRoleConverter : BaseConverter
    {
        ...
        protected override Resource PerformElementConversion(XElement element, ConversionContext context)
        {
            ...
            role.Meta.ProfileElement.Add(new FhirUri("http://hl7.org/fhir/us/core/StructureDefinition/us-core-practitionerrole"));
